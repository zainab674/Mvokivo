        ...
        <div className="flex items-center justify-between mb-4">
          ...
          {hasAnalysisData && !isSaved && (
            <Button
              ...
              size="sm"
              variant="outline"
              className="h-8 px-3 text-xs bg-primary/10 border-primary/50 text-primary hover:bg-primary/20 hover:border-primary/70"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-4 bg-secondary/50 rounded-lg border border-border">
                ...
                <div className="text-lg font-semibold text-foreground">{conversation.totalCalls}</div>
              </div>
              <div className="p-4 bg-secondary/50 rounded-lg border border-border">
                <div className="text-xs text-muted-foreground mb-1">Duration</div>
                <div className="text-lg font-semibold text-foreground">{conversation.totalDuration}</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            {hasAnalysisData ? (
              ...
              <div className="p-4 bg-secondary/30 rounded-lg border border-border text-xs text-muted-foreground text-center">
          ...
          {/* Last Call Outcome */}
          <div className="space-y-3">
            <h3 className="text-sm font-semibold text-foreground">Last Call Outcome</h3>
            <div className="p-4 bg-secondary/30 rounded-lg border border-border">
              {(() => {
                const latestOutcome = getLatestCallOutcome();
                if (!latestOutcome) {
                  return (
                    <Badge variant="default" className="text-xs text-muted-foreground bg-muted px-3 py-1 border border-border">
                      No outcome recorded
                    </Badge>
                  );
                }
                ...
                return (
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant="secondary"
                      className="text-xs px-3 py-1 bg-primary/20 text-primary border-primary/30"
                    >
                      {latestOutcome}
                    </Badge>
                  </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" className="text-xs h-7 px-3 rounded-lg text-muted-foreground hover:text-foreground hover:bg-secondary/50">
                Add Note
              </Button>
            </div>
            <div className="p-4 bg-secondary/30 rounded-lg border border-border text-xs text-muted-foreground text-center">
