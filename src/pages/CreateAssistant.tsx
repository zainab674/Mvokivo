...
const CreateAssistant = () => {
        ...
        if (data) {
          setFormData({
            ...
            advanced: {
              ...
              punctuationDelaySeconds: data.voice_on_punctuation_seconds || 0.1,
              noPunctuationDelaySeconds: data.voice_on_no_punctuation_seconds || 1.5,
  ...
  const mapFormToAssistantPayload = async () => {
    return {
      ...
      max_call_duration: formData.advanced.maxCallDuration || 30,
      num_words_to_interrupt_assistant: formData.advanced.numWordsToInterruptAssistant || 3,
      voice_on_punctuation_seconds: formData.advanced.punctuationDelaySeconds || 0.1,
      voice_on_no_punctuation_seconds: formData.advanced.noPunctuationDelaySeconds || 1.5,
      idle_messages: formData.advanced.idleMessages?.length ? formData.advanced.idleMessages : null,
      max_idle_messages: formData.advanced.idleMessageMaxSpokenCount || 3,
